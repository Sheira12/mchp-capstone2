...
<div class="py-6 pb-20 space-y-5">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 no-print">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('admin.ledger.report', array_merge(request()->query(), ['export'=>'print'])) }}"
               target="_blank"
    ...
    <div id="print-area" class="space-y-5">
        ...
        {{-- Summary by Category --}}
        @if($byCategory->count())
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm print-section">
        ...
        @if($entries->count())
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm print-section mb-8">
        ...
        {{-- Period/Printed — flows naturally after signatures --}}
