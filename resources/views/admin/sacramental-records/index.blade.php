                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-2">
                            <a href="{{ route('admin.sacramental-records.show', $record) }}" class="text-blue-600 hover:underline text-xs">View</a>
                            <a href="{{ route('admin.sacramental-records.edit', $record) }}" class="text-gray-600 hover:underline text-xs">Edit</a>
                        </div>
                    </td>
                </tr>
                @empty
