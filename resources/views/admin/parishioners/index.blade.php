                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('admin.parishioners.show', $parishioner) }}" class="text-blue-600 hover:text-blue-800 text-xs">View</a>
                                <a href="{{ route('admin.parishioners.edit', $parishioner) }}" class="text-gray-500 hover:text-gray-700 text-xs">Edit</a>
                            </div>
                        </td>
                    </tr>
                    @empty
