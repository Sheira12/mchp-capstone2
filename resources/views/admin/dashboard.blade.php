...
<div class="py-6 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-24 bg-gray-100 rounded-full h-2">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $count > 0 ? min(100, ($count / max(array_values($stats['sacramentCounts']) ?: [1])) * 100) : 0 }}%"></div>
                        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <form action="{{ route('admin.dashboard.export') }}" method="POST" class="flex flex-wrap gap-3 items-end">
            @csrf
            <div>
