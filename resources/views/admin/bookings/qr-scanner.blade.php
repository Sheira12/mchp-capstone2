    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div class="lg:col-span-7">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                {{-- Card header --}}
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4 flex items-center gap-4">
                ...
                <div class="p-5 space-y-4">
                    ...
                    {{-- Camera viewport: 16:9 matches webcam ratio exactly — no black bars --}}
                    <div class="relative rounded-2xl overflow-hidden bg-gray-950 w-full"
                        ...
                        <div id="scan-overlay" class="absolute inset-0 pointer-events-none hidden">
                            <div class="absolute inset-0"
                                 style="background:radial-gradient(ellipse at center,transparent 38%,rgba(0,0,0,.55) 100%);">
                            </div>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="relative" style="width:42%;aspect-ratio:1;">
                                    <div class="absolute top-0 left-0 w-9 h-9 border-t-4 border-l-4 border-blue-400 rounded-tl-2xl"></div>
                                    <div class="absolute top-0 right-0 w-9 h-9 border-t-4 border-r-4 border-blue-400 rounded-tr-2xl"></div>
                                    <div class="absolute bottom-0 left-0 w-9 h-9 border-b-4 border-l-4 border-blue-400 rounded-bl-2xl"></div>
                                    <div class="absolute bottom-0 right-0 w-9 h-9 border-b-4 border-r-4 border-blue-400 rounded-br-2xl"></div>
                                    <div id="scan-line"
                        ...
                        <div id="camera-status"
                             class="absolute inset-0 flex flex-col items-center justify-center bg-gray-950/92">
