...
<div class="page">
    <div class="border-outer">
        <div class="border-inner">
            ...
            <div class="cert-subtitle">Katibayan ng Unang Komunyon</div>
            <p class="body-text">
                This is to certify that <span class="field">{{ $certificate->parishioner->full_name }}</span>
                received the Sacrament of the <strong>Holy Eucharist</strong> for the first time in this parish on
