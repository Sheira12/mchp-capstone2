...
<div class="cert-content">
    ...
    <div class="cert-title-wrap">
        ...
        <span class="cert-title">Certificate of Confirmation</span>
        <span class="cert-sub">Katibayan ng Kumpil &nbsp;·&nbsp; Sacramentum Confirmationis</span>
        <span class="gold-orn-sm">{!! $ornSm !!}</span>
        <span class="cert-intro">Be it known to all that the following person has received<br>the Sacrament of Confirmation in the Holy Catholic Church</span>
    </div>
    <div class="recipient-wrap">
        <span class="recipient-name {{ $nameCls }}">{{ $certificate->parishioner->full_name }}</span>
        <span class="recipient-role">Recipient of Confirmation</span>
    </div>
