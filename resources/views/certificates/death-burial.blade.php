...
<div class="page">
    <div class="border-outer">
        <div class="border-inner">
            ...
            <div class="cert-subtitle">Katibayan ng Kamatayan / Libing</div>
            <p class="body-text">
                This is to certify that <span class="field">{{ $certificate->parishioner->full_name }}</span>
                was given the <strong>Christian Burial</strong> rites in this parish on
            ...
            <table class="details-table">
                <tr>
                    ...
                    <td class="value">{{ $certificate->parishioner->age ?? '—' }}</td>
                </tr>
                <tr>
