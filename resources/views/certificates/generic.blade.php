...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cert-title { text-align: center; font-size: 20pt; font-weight: bold; color: #1a3a6b; letter-spacing: 2px; text-transform: uppercase; margin: 20px 0; }
        .body-text { font-size: 12pt; line-height: 2; text-align: justify; margin-bottom: 15px; }
        .field { display: inline-block; border-bottom: 1px solid #333; min-width: 180px; text-align: center; font-weight: bold; padding: 0 5px; }
...
<div class="page">
    <div class="border-outer">
        <div class="border-inner">
            ...
            <div class="header">
                <p style="font-size:11pt; color:#555; letter-spacing:2px; text-transform:uppercase;">Diocese of San Pablo</p>
            ...
            <p class="body-text">
                ...
                is a registered parishioner of this parish and that the information stated herein is true and correct
                based on our parish records.
            </p>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value">{{ $certificate->sacramentalRecord->date_administered?->format('F d, Y') ?? '—' }}</td>
                    <td class="label">Celebrant:</td>
                ...
                <tr>
                    ...
                    <td class="value" colspan="3">{{ $certificate->parishioner->address ?? '—' }}, {{ $certificate->parishioner->barangay }}</td>
                </tr>
            </table>
            ...
            <div class="signature-section">
                <div class="signature-block">
                    <div class="signature-line">
                        <strong>{{ $certificate->issuedBy?->name ?? 'Parish Secretary' }}</strong><br>
                        Parish Secretary
                    </div>
                </div>
                <div class="signature-block">
                    <div class="signature-line">
                        <strong>{{ $parish['priest'] }}</strong><br>
                        Parish Priest
                    </div>
                </div>
            </div>
