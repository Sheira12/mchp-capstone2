...
<div class="cert-body">
    ...
    <div class="intro">Be it known to all that the following person is a registered parishioner<br>of this Holy Catholic Parish and the information herein is true and correct</div>
    ...
    <div class="det-grid">
        <div class="det-col">
            ...
            <div class="det-item"><div class="det-lbl">Date</div><div class="det-val">{{ $certificate->sacramentalRecord->date_administered?->format('F d, Y') ?? '—' }}</div></div>
            <div class="det-item"><div class="det-lbl">Celebrant</div><div class="det-val {{ $certificate->sacramentalRecord->celebrant ? '' : 'na' }}">{{ $certificate->sacramentalRecord->celebrant ?? 'Not recorded' }}</div></div>
        ...
        <div class="det-col">
            <div class="det-item"><div class="det-lbl">Gender</div><div class="det-val">{{ ucfirst($certificate->parishioner->gender ?? 'Not recorded') }}</div></div>
