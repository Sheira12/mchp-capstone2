...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo { width: 70px; height: 70px; border-radius: 50%; object-fit: cover; margin: 0 auto 10px; display: block; }
    </style>
</head>
<body>
<div class="page">
    <div class="border-outer">
        <div class="border-inner">
            ...
            <div class="cert-subtitle">Katibayan ng Binyag</div>

            {{-- Body --}}
            <p class="body-text">
                This is to certify that <span class="field">{{ $certificate->parishioner->full_name }}</span>,
                child of <span class="field">{{ $certificate->sacramentalRecord?->notes ?? '___________________' }}</span>,
                was solemnly baptized in this parish on
            ...
            <table class="details-table">
                ...
                <tr>
                    <td class="label">Godfather (Ninong):</td>
                    <td class="value">{{ $certificate->sacramentalRecord?->godparents[0] ?? '—' }}</td>
                    <td class="label">Godmother (Ninang):</td>
                    <td class="value">{{ $certificate->sacramentalRecord?->godparents[1] ?? '—' }}</td>
                </tr>
                <tr>
            ...
            <p class="cert-number" style="text-align:center; margin-top: 20px;">
