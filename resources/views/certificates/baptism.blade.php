...
{{-- FIXED BORDER OVERLAYS: rendered as PDF layer, zero impact on page count --}}
<div class="border-outer"></div>
<div class="border-navy"></div>
<div class="border-gold"></div>

{{-- ALL CERTIFICATE CONTENT flows normally, single page --}}
<div class="cert-content">
        ...
        <div class="seal-ring">
            ...
            @else
                <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="33" cy="33" r="25" stroke="#D4AF37" stroke-width="0.5" opacity="0.4"/>
                    <text x="33" y="30" text-anchor="middle" font-family="Georgia,serif" font-size="9" font-weight="bold" fill="#1F3A5F">MHC</text>
                    <text x="33" y="41" text-anchor="middle" font-family="Georgia,serif" font-size="7" fill="#D4AF37">PARISH</text>
                </svg>
            @endif
        </div>
    ...
    <div class="cert-title-wrap">
        ...
        <span class="cert-title">Certificate of Baptism</span>
        <span class="cert-sub">Katibayan ng Binyag &nbsp;·&nbsp; Sacramentum Baptismi</span>
        <span class="gold-orn-sm">{!! $ornSm !!}</span>
        <span class="cert-intro">Be it known to all that the following person has been received<br>into the Holy Catholic Church through the Sacrament of Baptism</span>
    </div>

    <div class="recipient-wrap">
        <span class="recipient-name {{ $nameCls }}">{{ $certificate->parishioner->full_name }}</span>
        <span class="recipient-role">Recipient of Holy Baptism</span>
    </div>
