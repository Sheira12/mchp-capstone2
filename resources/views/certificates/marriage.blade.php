...
<div class="cert-content">
    ...
    <div class="cert-title-wrap">
        ...
        <span class="cert-title">Certificate of Marriage</span>
        <span class="cert-sub">Katibayan ng Kasal &nbsp;·&nbsp; Sacramentum Matrimonii</span>
        <span class="gold-orn-sm">{!! $ornSm !!}</span>
        <span class="cert-intro">Be it known to all that the following persons have been united<br>in the Sacrament of Holy Matrimony in the Holy Catholic Church</span>
    </div>
