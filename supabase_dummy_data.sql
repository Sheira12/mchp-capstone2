...
--   payments         : 38  (all methods, all statuses)
--   certificates     : 25
...
SELECT v.family_name, v.address, v.barangay, 'Cabuyao', 'Laguna', v.contact_number, '[DEMO] Demo family record.', NOW(), NOW()
FROM (VALUES
  ('[DEMO] Dela Cruz Family',    'Blk 3 Lot 12, Southville 1',  'Niugan',      '09171000001'),
  ('[DEMO] Reyes Family',        'Blk 7 Lot 5, Phase 2',        'Banay-banay', '09171000002'),
  ('[DEMO] Santos Family',       'Blk 12 Lot 8, Phase 3',       'Pulo',        '09171000003'),
  ('[DEMO] Bautista Family',     'Blk 1 Lot 20, Southville 2',  'Sala',        '09171000004'),
  ('[DEMO] Flores Family',       'Blk 9 Lot 3, Phase 4',        'Marinig',     '09171000005'),
  ('[DEMO] Torres Family',       'Blk 5 Lot 17, Southville 1',  'Niugan',      '09171000006'),
  ('[DEMO] Villanueva Family',   'Blk 14 Lot 6, Phase 1',       'Diezmo',      '09171000007'),
  ('[DEMO] Aquino Family',       'Blk 2 Lot 9, Southville 3',   'Mamatid',     '09171000008'),
  ('[DEMO] Garcia Family',       'Blk 6 Lot 11, Phase 2',       'Bigaa',       '09171000009'),
  ('[DEMO] Mendoza Family',      'Blk 8 Lot 4, Southville 4',   'Casile',      '09171000010'),
  ('[DEMO] Cruz Family',         'Blk 11 Lot 7, Phase 5',       'Butong',      '09171000011'),
  ('[DEMO] Ramos Family',        'Blk 4 Lot 15, Southville 1',  'Niugan',      '09171000012'),
  ('[DEMO] Castillo Family',     'Blk 16 Lot 2, Phase 3',       'Gulod',       '09171000013'),
  ('[DEMO] Morales Family',      'Blk 10 Lot 18, Southville 2', 'Pittland',    '09171000014'),
  ('[DEMO] Gonzales Family',     'Blk 13 Lot 1, Phase 1',       'Sucol',       '09171000015'),
  ('[DEMO] Hernandez Family',    'Blk 15 Lot 13, Southville 3', 'Sala',        '09171000016'),
  ('[DEMO] Pascual Family',      'Blk 17 Lot 10, Phase 2',      'Niugan',      '09171000017'),
  ('[DEMO] Soriano Family',      'Blk 18 Lot 14, Southville 4', 'Banay-banay', '09171000018'),
  ('[DEMO] Navarro Family',      'Blk 19 Lot 16, Phase 4',      'Pulo',        '09171000019'),
  ('[DEMO] Salazar Family',      'Blk 20 Lot 19, Southville 5', 'Marinig',     '09171000020')
) AS v(family_name, address, barangay, contact_number)
WHERE NOT EXISTS (
  SELECT 1 FROM families WHERE family_name = v.family_name
);

-- ============================================================
-- STEP 2: PARISHIONERS (50 records)
-- Linked to the families above via subquery
-- ============================================================
...
SELECT
  f.id,
  v.first_name, v.middle_name, v.last_name, v.suffix, v.birthdate::date,
  v.gender, v.civil_status,
  'Demo Street, Southville 1', v.barangay, 'Cabuyao', 'Laguna', '4025',
  v.contact_number, v.email,
  v.is_head, v.relation,
  TRUE, '[DEMO] Demo parishioner — safe to delete.',
  v.created_at::timestamp, v.created_at::timestamp
FROM (VALUES
  ('[DEMO] Dela Cruz Family', 'Antonio',    'Santos',      'Dela Cruz',   NULL,     '1985-03-12', 'male',   'married',   'Niugan',      '09181000001', 'demo.parishioner001@example.com', TRUE,  'Head',   '2025-01-15'),
  ('[DEMO] Dela Cruz Family', 'Marilou',    'Reyes',       'Dela Cruz',   NULL,     '1988-07-25', 'female', 'married',   'Niugan',      '09181000002', 'demo.parishioner002@example.com', FALSE, 'Spouse', '2025-01-15'),
  ('[DEMO] Reyes Family',     'Jose',       'Bautista',    'Reyes',       NULL,     '1972-11-08', 'male',   'widowed',   'Banay-banay', '09181000003', 'demo.parishioner003@example.com', TRUE,  'Head',   '2025-02-10'),
  ('[DEMO] Santos Family',    'Rosa',       'Flores',      'Santos',      NULL,     '2000-01-30', 'female', 'single',    'Pulo',        '09181000004', 'demo.parishioner004@example.com', TRUE,  'Head',   '2025-02-20'),
  ('[DEMO] Bautista Family',  'Miguel',     'Cruz',        'Bautista',    NULL,     '1968-06-14', 'male',   'married',   'Sala',        '09181000005', 'demo.parishioner005@example.com', TRUE,  'Head',   '2025-03-05'),
  ('[DEMO] Flores Family',    'Elena',      'Reyes',       'Flores',      NULL,     '1995-09-03', 'female', 'single',    'Marinig',     '09181000006', 'demo.parishioner006@example.com', FALSE, 'Child',  '2025-03-10'),
  ('[DEMO] Torres Family',    'Carlos',     'Villanueva',  'Torres',      NULL,     '1980-12-19', 'male',   'married',   'Niugan',      '09181000007', 'demo.parishioner007@example.com', TRUE,  'Head',   '2025-03-20'),
  ('[DEMO] Villanueva Family','Luz',         'Aquino',     'Villanueva',  NULL,     '2005-04-22', 'female', 'single',    'Diezmo',      '09181000008', 'demo.parishioner008@example.com', FALSE, 'Child',  '2025-04-01'),
  ('[DEMO] Aquino Family',    'Ramon',      'Torres',      'Aquino',      NULL,     '1958-08-07', 'male',   'married',   'Mamatid',     '09181000009', 'demo.parishioner009@example.com', TRUE,  'Head',   '2025-04-15'),
  ('[DEMO] Garcia Family',    'Cecilia',    'Bautista',    'Garcia',      NULL,     '1943-02-11', 'female', 'widowed',   'Bigaa',       '09181000010', 'demo.parishioner010@example.com', TRUE,  'Head',   '2025-05-01'),
  ('[DEMO] Mendoza Family',   'Eduardo',    'Santos',      'Mendoza',     'Jr.',    '1977-05-16', 'male',   'married',   'Casile',      '09181000011', 'demo.parishioner011@example.com', TRUE,  'Head',   '2025-05-10'),
  ('[DEMO] Cruz Family',      'Maricel',    'Diaz',        'Cruz',        NULL,     '1983-09-22', 'female', 'married',   'Butong',      '09181000012', 'demo.parishioner012@example.com', TRUE,  'Head',   '2025-05-20'),
  ('[DEMO] Ramos Family',     'Fernando',   'Ocampo',      'Ramos',       NULL,     '1960-12-03', 'male',   'separated', 'Niugan',      '09181000013', 'demo.parishioner013@example.com', TRUE,  'Head',   '2025-06-01'),
  ('[DEMO] Castillo Family',  'Josephine',  'Navarro',     'Castillo',    NULL,     '1990-03-18', 'female', 'single',    'Gulod',       '09181000014', 'demo.parishioner014@example.com', TRUE,  'Head',   '2025-06-10'),
  ('[DEMO] Morales Family',   'Renato',     'Soriano',     'Morales',     NULL,     '1975-07-29', 'male',   'married',   'Pittland',    '09181000015', 'demo.parishioner015@example.com', TRUE,  'Head',   '2025-07-01'),
  ('[DEMO] Gonzales Family',  'Evelyn',     'Pascual',     'Gonzales',    NULL,     '1988-11-14', 'female', 'married',   'Sucol',       '09181000016', 'demo.parishioner016@example.com', FALSE, 'Spouse', '2025-07-15'),
  ('[DEMO] Hernandez Family', 'Danilo',     'Martinez',    'Hernandez',   NULL,     '2001-09-14', 'male',   'single',    'Sala',        '09181000017', 'demo.parishioner017@example.com', FALSE, 'Child',  '2025-08-01'),
  ('[DEMO] Pascual Family',   'Teresita',   'Aguilar',     'Pascual',     NULL,     '1965-04-07', 'female', 'widowed',   'Niugan',      '09181000018', 'demo.parishioner018@example.com', TRUE,  'Head',   '2025-08-15'),
  ('[DEMO] Soriano Family',   'Oscar',      'Lim',         'Soriano',     NULL,     '1993-12-25', 'male',   'single',    'Banay-banay', '09181000019', 'demo.parishioner019@example.com', TRUE,  'Head',   '2025-09-01'),
  ('[DEMO] Salazar Family',   'Patricia',   'Tan',         'Salazar',     NULL,     '1970-06-30', 'female', 'annulled',  'Marinig',     '09181000020', 'demo.parishioner020@example.com', TRUE,  'Head',   '2025-09-15'),
  -- Additional parishioners for volume
  ('[DEMO] Dela Cruz Family', 'Marco',      'Santos',      'Dela Cruz',   NULL,     '2010-02-14', 'male',   'single',    'Niugan',      '09182000001', NULL,                              FALSE, 'Child',  '2025-10-01'),
  ('[DEMO] Reyes Family',     'Ana',        'Bautista',    'Reyes',       NULL,     '1992-08-19', 'female', 'married',   'Banay-banay', '09182000002', NULL,                              FALSE, 'Child',  '2025-10-10'),
  ('[DEMO] Santos Family',    'Pedro',      'Torres',      'Santos',      NULL,     '1955-03-25', 'male',   'married',   'Pulo',        '09182000003', NULL,                              FALSE, 'Spouse', '2025-10-20'),
  ('[DEMO] Bautista Family',  'Gloria',     'Cruz',        'Bautista',    NULL,     '1975-11-08', 'female', 'married',   'Sala',        '09182000004', NULL,                              FALSE, 'Spouse', '2025-11-01'),
  ('[DEMO] Flores Family',    'Rodrigo',    'Mendoza',     'Flores',      NULL,     '1948-07-12', 'male',   'widowed',   'Marinig',     '09182000005', NULL,                              FALSE, 'Parent', '2025-11-10'),
  ('[DEMO] Torres Family',    'Melinda',    'Garcia',      'Torres',      NULL,     '1982-04-03', 'female', 'married',   'Niugan',      '09182000006', NULL,                              FALSE, 'Spouse', '2025-11-20'),
  ('[DEMO] Aquino Family',    'Arturo',     'Hernandez',   'Aquino',      NULL,     '1988-09-17', 'male',   'married',   'Mamatid',     '09182000007', NULL,                              FALSE, 'Spouse', '2025-12-01'),
  ('[DEMO] Mendoza Family',   'Cecilia',    'Ramos',       'Mendoza',     NULL,     '1980-01-28', 'female', 'married',   'Casile',      '09182000008', NULL,                              FALSE, 'Spouse', '2025-12-15'),
  ('[DEMO] Cruz Family',      'Domingo',    'Castillo',    'Cruz',        NULL,     '1940-05-20', 'male',   'widowed',   'Butong',      '09182000009', NULL,                              FALSE, 'Parent', '2026-01-05'),
  ('[DEMO] Garcia Family',    'Florencia',  'Morales',     'Garcia',      NULL,     '1963-10-11', 'female', 'married',   'Bigaa',       '09182000010', NULL,                              FALSE, 'Spouse', '2026-01-15'),
  ('[DEMO] Ramos Family',     'Gregorio',   'Gonzales',    'Ramos',       NULL,     '1970-02-07', 'male',   'married',   'Niugan',      '09182000011', NULL,                              FALSE, 'Spouse', '2026-02-01'),
  ('[DEMO] Castillo Family',  'Herminia',   'Santos',      'Castillo',    NULL,     '1997-06-15', 'female', 'single',    'Gulod',       '09182000012', NULL,                              FALSE, 'Child',  '2026-02-15'),
  ('[DEMO] Morales Family',   'Isidro',     'Reyes',       'Morales',     NULL,     '1985-12-22', 'male',   'married',   'Pittland',    '09182000013', NULL,                              FALSE, 'Spouse', '2026-03-01'),
  ('[DEMO] Gonzales Family',  'Juliana',    'Cruz',        'Gonzales',    NULL,     '2003-03-30', 'female', 'single',    'Sucol',       '09182000014', NULL,                              FALSE, 'Child',  '2026-03-15'),
  ('[DEMO] Hernandez Family', 'Kevin',      'Torres',      'Hernandez',   NULL,     '2007-09-05', 'male',   'single',    'Sala',        '09182000015', NULL,                              FALSE, 'Child',  '2026-04-01'),
  ('[DEMO] Pascual Family',   'Lorena',     'Bautista',    'Pascual',     NULL,     '1960-07-18', 'female', 'widowed',   'Niugan',      '09182000016', NULL,                              FALSE, 'Sister', '2026-04-10'),
  ('[DEMO] Soriano Family',   'Manuel',     'Flores',      'Soriano',     NULL,     '1978-01-09', 'male',   'married',   'Banay-banay', '09182000017', NULL,                              FALSE, 'Spouse', '2026-04-20'),
  ('[DEMO] Salazar Family',   'Natividad',  'Aquino',      'Salazar',     NULL,     '1955-08-24', 'female', 'widowed',   'Marinig',     '09182000018', NULL,                              FALSE, 'Parent', '2026-05-01'),
  ('[DEMO] Dela Cruz Family', 'Quirino',    'Dela Cruz',   'Santos',      NULL,     '2012-11-16', 'male',   'single',    'Niugan',      '09182000019', NULL,                              FALSE, 'Child',  '2026-05-15'),
  ('[DEMO] Reyes Family',     'Remedios',   'Torres',      'Reyes',       NULL,     '1973-04-02', 'female', 'married',   'Banay-banay', '09182000020', NULL,                              FALSE, 'Sister', '2026-05-20'),
  ('[DEMO] Bautista Family',  'Salvador',   'Mendoza',     'Bautista',    NULL,     '1965-06-30', 'male',   'married',   'Sala',        '09183000001', NULL,                              FALSE, 'Brother','2026-06-01'),
  ('[DEMO] Flores Family',    'Teofilo',    'Cruz',        'Flores',      NULL,     '1990-10-05', 'male',   'single',    'Marinig',     '09183000002', NULL,                              FALSE, 'Child',  '2026-06-10'),
  ('[DEMO] Torres Family',    'Veronica',   'Garcia',      'Torres',      NULL,     '2001-02-18', 'female', 'single',    'Niugan',      '09183000003', NULL,                              FALSE, 'Child',  '2026-06-20'),
  ('[DEMO] Aquino Family',    'Wilfredo',   'Santos',      'Aquino',      NULL,     '1958-11-27', 'male',   'married',   'Mamatid',     '09183000004', NULL,                              FALSE, 'Brother','2026-07-01'),
  ('[DEMO] Cruz Family',      'Yolanda',    'Ramos',       'Cruz',        NULL,     '1985-03-15', 'female', 'married',   'Butong',      '09183000005', NULL,                              FALSE, 'Spouse', '2026-07-10'),
  ('[DEMO] Ramos Family',     'Zenaida',    'Castillo',    'Ramos',       NULL,     '1962-08-09', 'female', 'separated', 'Niugan',      '09183000006', NULL,                              FALSE, 'Sister', '2026-07-20'),
  ('[DEMO] Garcia Family',    'Ariel',      'Morales',     'Garcia',      NULL,     '1995-05-14', 'male',   'single',    'Bigaa',       '09183000007', NULL,                              FALSE, 'Child',  '2026-08-01'),
  ('[DEMO] Mendoza Family',   'Bernadette', 'Gonzales',    'Mendoza',     NULL,     '2008-01-22', 'female', 'single',    'Casile',      '09183000008', NULL,                              FALSE, 'Child',  '2026-08-10'),
  ('[DEMO] Gonzales Family',  'Cesar',      'Hernandez',   'Gonzales',    NULL,     '1980-07-03', 'male',   'married',   'Sucol',       '09183000009', NULL,                              FALSE, 'Spouse', '2026-08-20'),
  ('[DEMO] Pascual Family',   'Diana',      'Pascual',     'Santos',      NULL,     '1993-12-12', 'female', 'single',    'Niugan',      '09183000010', NULL,                              FALSE, 'Niece',  '2026-09-01')
) AS v(family_name, first_name, middle_name, last_name, suffix, birthdate, gender, civil_status, barangay, contact_number, email, is_head, relation, created_at)
INNER JOIN families f ON f.family_name = v.family_name
WHERE NOT EXISTS (
  SELECT 1 FROM parishioners p
  WHERE p.contact_number = v.contact_number
);

-- ============================================================
-- STEP 3: USERS for parishioner portal login (first 20 only)
-- Password hash = bcrypt('DemoPass@2026')
...
SELECT
  ...
  v.date_admin::timestamp,
  v.date_admin::timestamp
FROM (VALUES
  -- Baptisms (contact numbers used as join key since email may be null for extra parishioners)
  ...
  -- Recent (current year — for dashboard charts)
...
WHERE NOT EXISTS (
  ...
  WHERE sr.parishioner_id = p.id AND sr.type = v.type AND sr.register_number = v.register_number
);

-- ============================================================
-- STEP 5: BOOKINGS (45 records, 6 months, all statuses)
-- ============================================================
INSERT INTO bookings (
  parishioner_id, booking_type, scheduled_date, scheduled_time,
  status, service_fee, notes, reminder_sent, created_at, updated_at
)
SELECT
  p.id,
  v.booking_type,
...
FROM (VALUES
  ...
  -- September 2026 (current month — mix of statuses)
...
-- ============================================================
-- STEP 6: PAYMENTS (38 records)
-- No real PayMongo IDs — all demo/local records only
-- ============================================================
...
SELECT
  ...
  'debit',
  v.status,
  CASE WHEN v.status = 'paid' THEN (b.scheduled_date + INTERVAL '1 day')::timestamp ELSE NULL END,
  CASE WHEN v.status = 'paid' THEN (b.scheduled_date + INTERVAL '1 day')::timestamp ELSE NULL END,
...
FROM (VALUES
  ...
  -- Confirmed → pending (awaiting admin approval)
  ...
  -- Upcoming → no payment yet (skip; only create pending for the ones paid)
  -- Cancelled booking → failed payment
...
INSERT INTO certificates (
  parishioner_id, type, issued_date, purpose, status, notes, created_at, updated_at
)
SELECT
  p.id,
  v.cert_type,
...
-- ============================================================
-- STEP 8: LEDGER ENTRIES (60 records — 6 months of financials)
-- ============================================================
INSERT INTO ledger_entries (type, category, description, amount, entry_date, reference_number, created_at, updated_at)
SELECT v.type, v.category, v.description, v.amount::numeric, v.entry_date::date, v.ref, NOW(), NOW()
FROM (VALUES
  -- April 2026
...
) AS v(type, category, description, amount, entry_date, ref)
WHERE NOT EXISTS (
...
SELECT v.title, v.description, v.location, v.event_start::timestamp, v.event_end::timestamp, v.category, 'published', v.featured, NOW(), NOW()
FROM (VALUES
  ...
  ('Couples for Christ Monthly Meeting',
   '<p>Regular CFC community meeting focusing on marriage enrichment and family prayer. Short teaching followed by small group sharing.</p>',
   'Parish Hall, Mary Help of Christians Parish',
   '2026-09-17 19:00', '2026-09-17 21:30', 'community', FALSE),
  ('First Friday Mass & Eucharistic Adoration',
   '<p>Special votive Mass of the Sacred Heart at 6:00 PM followed by Eucharistic Adoration from 7:00–9:00 PM.</p>',
   'Mary Help of Christians Parish Church',
   '2026-09-05 18:00', '2026-09-05 21:00', 'general', FALSE),
  ('Summer Youth Leadership Camp 2026',
   '<p>Three-day Summer Leadership Camp. Over 45 youth participants. Theme: "Lead with Faith, Serve with Love" (Mark 10:45).</p>',
   'Camp Crame, Quezon City',
   '2026-04-10 07:00', '2026-04-12 18:00', 'youth', FALSE),
  ('Lenten Reconciliation Service 2026',
   '<p>Special Penitential Service. Several priests from neighboring parishes assisted in hearing confessions. Over 200 parishioners participated.</p>',
   'Mary Help of Christians Parish Church',
   '2026-03-27 19:00', '2026-03-27 22:00', 'sacrament', FALSE),
  ('Simbang Gabi 2025 — Nine-Day Novena of Masses',
   '<p>Traditional Simbang Gabi held December 16–24, 2025 at 4:00 AM daily. Special Filipino breakfast served after each Mass.</p>',
   'Mary Help of Christians Parish Church',
...
SELECT v.title, v.content, 'general', TRUE, v.pub_at::timestamp, v.exp_at::timestamp, NOW(), NOW()
FROM (VALUES
  ...
  ('Pre-Baptismal Seminar — September 20, 2026',
   '<p><strong>Date:</strong> September 20, 2026 (Saturday)<br><strong>Time:</strong> 2:00 PM – 5:00 PM<br><strong>Venue:</strong> Parish Hall</p><p>Requirements: Birth Certificate, Marriage Certificate (parents), Baptismal & Confirmation Certificates.</p>',
   '2026-09-01', '2026-09-21'),
  ('Registration Open: Confirmation 2026–2027',
   '<p>Accepting applications for <strong>Confirmation Catechesis 2026–2027</strong>. Requirements: Baptismal Certificate, First Communion Certificate, 1×1 photo, ₱200 registration fee. Deadline: October 15, 2026.</p>',
  ...
  ('Parish Office Closed — September 8 (Nativity of BVM)',
   '<p>Parish Office closed on September 8, 2026. Solemn Mass at 9:00 AM in honor of Our Lady''s birthday. Normal office hours resume September 9.</p>',
   '2026-09-05', '2026-09-09'),
  ('Marriage Banns — Torres & Mendez',
   '<p><strong>First Reading of Banns</strong><br>Juan Carlo Torres and Ana Maria Mendez. Solemnization: October 12, 2026, 10:00 AM at Mary Help of Christians Parish.</p>',
   '2026-08-25', '2026-10-15'),
  ('Volunteers Needed — Outreach Ministry',
   '<p>Volunteers needed for Medical and Dental Mission on September 28, 2026 at Southville 5. Volunteer doctors, nurses, students, and logistics helpers welcome.</p>',
...
SELECT v.title, v.description, v.yt_url, v.yt_id, v.type, v.sched::timestamp, TRUE, v.featured, NOW(), NOW()
FROM (VALUES
  ('Sunday Mass — September 7, 2026',
   'Live Holy Eucharist — 23rd Sunday in Ordinary Time. Presided by Rev. Fr. Erwin S. Sanchez.',
   'https://www.youtube.com/watch?v=dQw4w9WgXcQ','dQw4w9WgXcQ','recorded','2026-09-07 09:00',FALSE),
  ('Sunday Mass — August 31, 2026',
   'Live Holy Eucharist — 22nd Sunday in Ordinary Time. Presided by Rev. Fr. Erwin S. Sanchez.',
   'https://www.youtube.com/watch?v=jNQXAC9IVRw','jNQXAC9IVRw','recorded','2026-08-31 09:00',FALSE),
  ('Parish Anniversary Solemn Mass 2026',
   'Solemn Mass for the Feast of Mary Help of Christians and the Parish Anniversary. May 24, 2026.',
   'https://www.youtube.com/watch?v=9bZkp7q19f0','9bZkp7q19f0','recorded','2026-05-24 09:00',TRUE),
  ('Lenten Recollection 2026',
   'Special Lenten recollection and communal penance service with guest speaker.',
   'https://www.youtube.com/watch?v=kXYiU_JCYtU','kXYiU_JCYtU','recorded','2026-03-27 19:00',FALSE),
  ('Sunday Mass — September 14, 2026 (UPCOMING)',
   'Join us live for the Holy Eucharist — 24th Sunday in Ordinary Time at 9:00 AM.',
   'https://www.youtube.com/watch?v=tPEE9ZwImy0','tPEE9ZwImy0','upcoming','2026-09-14 09:00',TRUE)
) AS v(title, description, yt_url, yt_id, type, sched, featured)
WHERE NOT EXISTS (
  SELECT 1 FROM livestreams ls WHERE ls.title = v.title
);
...
-- ============================================================
SELECT
  'families'            AS "table", COUNT(*) AS total FROM families WHERE family_name LIKE '[DEMO]%'
UNION ALL SELECT 'parishioners', COUNT(*) FROM parishioners WHERE notes LIKE '[DEMO]%'
UNION ALL SELECT 'users (demo)', COUNT(*) FROM users WHERE email LIKE 'demo.parishioner%@example.com'
UNION ALL SELECT 'sacramental_records', COUNT(*) FROM sacramental_records WHERE notes LIKE '[DEMO]%'
UNION ALL SELECT 'bookings', COUNT(*) FROM bookings WHERE notes LIKE '[DEMO]%'
UNION ALL SELECT 'payments', COUNT(*) FROM payments WHERE notes LIKE '[DEMO]%'
UNION ALL SELECT 'certificates', COUNT(*) FROM certificates WHERE notes LIKE '[DEMO]%'
UNION ALL SELECT 'ledger_entries', COUNT(*) FROM ledger_entries WHERE reference_number LIKE '%2604%' OR reference_number LIKE '%2605%' OR reference_number LIKE '%2606%' OR reference_number LIKE '%2607%' OR reference_number LIKE '%2608%' OR reference_number LIKE '%2609%'
UNION ALL SELECT 'events', COUNT(*) FROM events
UNION ALL SELECT 'announcements', COUNT(*) FROM announcements
UNION ALL SELECT 'livestreams', COUNT(*) FROM livestreams;
