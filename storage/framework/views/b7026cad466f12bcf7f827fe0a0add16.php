...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — <?php echo e(config('parish.name')); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/parish-logo.png')); ?>">
...
<div class="min-h-full flex">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-blue-900 text-white flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-300">
        ...
        <div class="flex items-center gap-3 px-6 py-5 border-b border-blue-800">
            <img src="<?php echo e(asset('images/parish-logo.png')); ?>" alt="Parish Logo" class="w-10 h-10 rounded-full object-cover">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="<?php echo e(route('admin.parishioners.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.parishioners.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Parishioners
            </a>
            <a href="<?php echo e(route('admin.families.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.families.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Families
            </a>

            <div class="pt-2 pb-1 px-3 text-xs font-semibold text-blue-400 uppercase tracking-wider">Records</div>
            <a href="<?php echo e(route('admin.sacramental-records.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.sacramental-records.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Sacramental Records
            </a>
            <a href="<?php echo e(route('admin.certificates.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.certificates.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.bookings.calendar')); ?>" class="nav-link">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Calendar
            </a>

            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super_admin|finance_officer')): ?>
            ...
            <a href="<?php echo e(route('admin.payments.report')); ?>" class="nav-link">
            ...
            <a href="<?php echo e(route('admin.mass-schedules.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.mass-schedules.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="nav-link">
        ...
        <div class="border-t border-blue-800 p-4">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-blue-300 truncate"><?php echo e(auth()->user()->getRoleNames()->first()); ?></p>
                </div>
    ...
    <div class="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-40">
            <div class="flex items-center justify-between px-4 py-3">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('home')); ?>" target="_blank" class="text-sm text-blue-600 hover:underline">View Website</a>
                </div>
            </div>
        </header>
        ...
        <footer class="text-center text-xs text-gray-400 py-4 border-t">
            © <?php echo e(date('Y')); ?> <?php echo e(config('parish.name')); ?> — All rights reserved.
        </footer>
    </div>
</div>
...
<?php /**PATH C:\Users\Admin\Capstone 2\resources\views/layouts/app.blade.php ENDPATH**/ ?>